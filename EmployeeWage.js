...
console.log("UC8 Emp wage with Map: "+Array.from(empDailyWageMap.values()).reduce(totalWages,0))
...
console.log("UC9A Emp Wage with Arrow :  Total Hrs: "+ totalHours+ " total wages: "+totalSalary);
